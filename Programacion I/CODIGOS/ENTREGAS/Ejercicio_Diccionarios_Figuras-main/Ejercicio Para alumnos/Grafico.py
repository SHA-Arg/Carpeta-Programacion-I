...
def dibujar_circulo(ventana, figura):
    pygame.draw.circle(
        ventana, figura["color"], figura["posicion"], figura["dimensiones"][0])


def dibujar_rectangulo(ventana, figura):
    pygame.draw.rect(ventana, figura["color"], (figura["posicion"][0],
                     figura["posicion"][1], figura["dimensiones"][0], figura["dimensiones"][1]))
...
def dibujar_triangulo(ventana, figura):
    ...
    puntos = [(pos_x, pos_y), (pos_x, pos_y+altura),
              (pos_x + base, pos_y+altura)]
